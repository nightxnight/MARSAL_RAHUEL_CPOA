...
public class ConfirmationAlert extends Alert{
	...
	public ConfirmationAlert(String title, String message, MainControleur parent) {
		super(AlertType.CONFIRMATION, message);
        this.setTitle(title);   
        this.getButtonTypes().clear();
        this.getButtonTypes().addAll(VALIDER, ANNULER);
        this.setGraphic(new ImageView("file:resources/images/confirmIcon.png"));
        
        Stage stage = (Stage) this.getDialogPane().getScene().getWindow();
        stage.getIcons().add(new Image("file:resources/images/confirmIcon.png"));
